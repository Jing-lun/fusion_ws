        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    // Initialize pointcloud mapping, new part
...
cv::Mat System::TrackRGBD(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp, const cv::Mat &imRGB_f)
{
    if(mSensor!=RGBD)
    {
    ...
    cv::Mat Tcw = mpTracker->GrabImageRGBD(im,depthmap,timestamp, imRGB_f);
